...
export const RepositoryDetails = () => {
    const [repositoryRender, setRepositoryRender] = useState<Repository>({});
    ...
    // setRepositoryRender(repositoryToRender);
    localStorage.setItem('RepoDetails', JSON.stringify(repositoryToRender));
        ...
        <div className="repositoryDetails">
            ...
            <div className="repositoryDetails__main">
                <div className="repositoryDetails__user">
                    ...
                    <a className="repositoryDetails__text" href={repositoryToRender.owner.url}>{repositoryToRender.owner.login}</a>
                </div>
